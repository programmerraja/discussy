            ...
            if(answers_obj){
              db.Question
                ...
                .then((question_obj)=>{
                  ...
                  let new_answers={"question":{...question_obj[0],isEditing:String(question_obj[0].userId)===String(req.user.id),
                  ...
                  answers_obj.forEach(ans=>{
                    ...
                    new_answers.answers.push({...ans,isEditing:String(ans.userId)===String(req.user.id),
                                                user:{_id:ans.user[0]._id,name:ans.user[0].name
